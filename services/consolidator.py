...
Körs vid: `python -m services.consolidator` eller `my_mem_chat.py --consolidate`
"""
...
try:
    ...
    from services.entity_consolidator import add_alias, get_known_entities
    from google import genai
except ImportError:
    from session_logger import get_unprocessed_sessions, mark_sessions_processed
    from entity_consolidator import add_alias, get_known_entities
    from google import genai
